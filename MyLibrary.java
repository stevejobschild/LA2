    	...
    	while (true) {
    		...
    		if (input.equals("search")) {
    			...
    			if (input.equals("title")) {
        			...
        			input = scanner.nextLine();
        			if (!input.equals("") && input.length() < 2 && Character.isDigit(input.charAt(0)) && Integer.parseInt(input) >= 1 && Integer.parseInt(input) <= 5) {
    			...
    			if (title == null || input == null || rating == null) {
    				...
    				if (rating.length() < 2 && Character.isDigit(rating.charAt(0)) && Integer.parseInt(rating) >= 1 && Integer.parseInt(rating) <= 5) {
